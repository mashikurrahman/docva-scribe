...
class _MfaEnrollmentScreenState extends State<MfaEnrollmentScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          icon: const Icon(Icons.close, color: Clinic.secondary),
      ...
      body: SafeArea(
        child: _loading
            ? const Center(child: CircularProgressIndicator(color: Clinic.primary))
            : _setupError != null
                ? _errorState()
                : _content(),
      ),
        ...
        child: Column(
          ...
          children: [
            Icon(Icons.error_outline,
                size: 44, color: Clinic.priorityHigh.withValues(alpha: 0.8)),
            const SizedBox(height: 14),
            Text(_setupError!,
                textAlign: TextAlign.center,
                style: const TextStyle(color: Clinic.brandNavy)),
      ...
      child: Column(
        ...
        children: [
          Text(
              ...
              style: TextStyle(color: Clinic.muted, fontSize: 13, height: 1.4)),
                  ...
                  : const SizedBox(
                      ...
                      child: Center(
                          child: Icon(Icons.qr_code_2,
                              size: 80, color: Clinic.secondary))),
            ),
          ),
          const SizedBox(height: 16),
  ...
  Widget _manualKey() {
    return Container(
      ...
      child: Row(
        children: [
          const Icon(Icons.vpn_key, size: 16, color: Clinic.secondary),
            ...
            child: Column(
              ...
              children: [
                Text(
                    ...
                    style: TextStyle(color: Clinic.muted, fontSize: 11)),
          ...
          IconButton(
            tooltip: 'Copy',
            icon: const Icon(Icons.copy, size: 18, color: Clinic.primary),
            onPressed: () {
  ...
  Widget _recoveryCodesBox() {
    return Container(
      ...
      decoration: BoxDecoration(
        color: Clinic.priorityMedium.withValues(alpha: 0.08),
        borderRadius: BorderRadius.circular(Clinic.rControl),
        border: Border.all(color: Clinic.priorityMedium.withValues(alpha: 0.35)),
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Row(
            children: [
              const Icon(Icons.shield_outlined,
                  size: 16, color: Clinic.priorityMedium),
          ...
          Text(
              ...
              style: TextStyle(color: Clinic.muted, fontSize: 11, height: 1.3)),
    ...
    return SizedBox(
      ...
      child: FilledButton(
        style: FilledButton.styleFrom(
          ...
          disabledBackgroundColor: Clinic.primary.withValues(alpha: 0.4),
          shape:
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        children: const [
                          Icon(Icons.verified_user, color: Clinic.primary),
                          SizedBox(width: 8),
                      ...
                      Text(
                          ...
                          style:
                              TextStyle(color: Clinic.muted, fontSize: 13)),
                      const SizedBox(height: 20),
                        ...
                        child: FilledButton(
                          style: FilledButton.styleFrom(
                            ...
                            disabledBackgroundColor:
                                Clinic.primary.withValues(alpha: 0.4),
  ...
  Widget build(BuildContext context) {
    return TextField(
      ...
      decoration: InputDecoration(
        ...
        hintText: '••••••',
        hintStyle: TextStyle(
            color: Clinic.muted.withValues(alpha: 0.4), letterSpacing: 10),
        filled: true,
        fillColor: Clinic.surfaceLight,
        ...
        focusedBorder: OutlineInputBorder(
            borderRadius: BorderRadius.circular(Clinic.rControl),
            borderSide: const BorderSide(color: Clinic.primary, width: 1.5)),
      ),
    );
  }
}
