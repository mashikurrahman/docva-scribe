                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        children: const [
                          Icon(Icons.lock_reset, color: Clinic.primary),
                          SizedBox(width: 8),
                          Expanded(
                      ...
                      Text(
                          ...
                          style: TextStyle(color: Clinic.muted, fontSize: 13)),
  ...
  Widget _passwordField(TextEditingController c, String label, bool obscure,
    ...
    return TextField(
      ...
      decoration: InputDecoration(
        labelText: label,
        prefixIcon: const Icon(Icons.lock_outline, color: Clinic.primary),
      ...
      child: Row(
        children: [
          Icon(met ? Icons.check_circle : Icons.radio_button_unchecked,
              size: 16,
              color: met ? Clinic.statusActive : Clinic.muted.withValues(alpha: 0.5)),
          const SizedBox(width: 8),
          Text(label,
              style: TextStyle(
                  fontSize: 12,
                  color: met ? Clinic.brandNavy : Clinic.muted,
...
class _PhiTrainingScreenState extends State<PhiTrainingScreen> {
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              gradient: const LinearGradient(
                colors: [Clinic.primary, Clinic.brandNavy],
            ...
            child: Column(
              ...
              children: [
                ...
                Text('Please review before your first access. This is required.',
                    style: TextStyle(color: Clinic.muted, fontSize: 12)),
              ],
            ),
          ),
        ],
  ...
  Widget _para(List<TextSpan> spans) => Padding(
        ...
        child: Text.rich(
          ...
          style: const TextStyle(
              color: Clinic.secondary, fontSize: 13.5, height: 1.55),
        ),
      );
                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        decoration: const BoxDecoration(
                            color: Clinic.secondary, shape: BoxShape.circle),
                      ),
                    ),
                    Expanded(
                      child: Text.rich(
            ...
            InkWell(
              ...
              child: Row(
                children: [
                  ...
                  const Expanded(
                    child: Text(
                        "I acknowledge that I have read and understand DOCVA's privacy practices",
                        style: TextStyle(
                            color: Clinic.brandNavy, fontSize: 13)),
                  ),
                ],
              ),
            ),
